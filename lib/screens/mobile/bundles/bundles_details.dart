// ignore_for_file: file_names, prefer_const_constructors, use_key_in_widget_constructors, unnecessary_new, prefer_const_literals_to_create_immutables
...
class BundleID extends StatefulWidget {
  int ID;
  BundleID(this.ID);
  @override
  _BundleIDState createState() => _BundleIDState();
}

class _BundleIDState extends State<BundleID> with TickerProviderStateMixin {
  ...
  late BundleDetails? product = null;
  bool loading = true;
                            ...
                            children: [
                              Container(
                                ...
                                child: PageView(
                                  ...
                                  children: [
                                    Image.network(product!.bundleImageUrl ?? ""),
                                    // Image.asset(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      createBundleWishList(widget.ID);
                                    },
                                    child: Container(
                                      width: 30,
                                      height: 30,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: (){
                                      Share.share('Check via http://dev.mymedicines.africa/bundle-details/${widget.ID}', subject: '${product!.bundleName},\n ${product!.description}');
                                          ...
                                          children: [
                                            Container(
                                              child: ListView(
                                                children: [
                                                  Text(
                                                    product!.precaution != null ? product!.precaution! : "",
                                                    style: TextStyle(
                                                        fontWeight: FontWeight.w500,
                                                        fontSize: 12,
                                                        fontFamily: "Poppins",
                                            ...
                                            Container(
                                              child: ListView(
                                                children: [
                                                  Text(
                                                    product!.howToUse != null ?product!.howToUse! : "",
                                                    style: TextStyle(
                                                        fontWeight: FontWeight.w500,
                                                        fontSize: 12,
                                                        fontFamily: "Poppins",
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(product != null ? product!.bundleName! + " added to cart" : "" ,
                                style: TextStyle(
                                  fontFamily: "Poppins",
                                  fontSize: 11,
                                  fontWeight: FontWeight.w600,
  ...
  void findProductByID(int id) {
    ...
    serviceClass.viewBundleByID(id).then((value) => bundleOutput(value));
    serviceClass.getRatings(widget.ID, true).then((value) => outputRating(value));
    serviceClass.avgRatings(widget.ID,true).then((value) => avgRatingOutput(value));
  ...
  void addToCart() {
    ...
    ServiceClass serviceClass = new ServiceClass();
    serviceClass.addBundleToCart(widget.ID,productQty).then((value) => addCartOutput(value));
  }
  ...
  void bundleOutput(String body) {
    ...
    if (body.contains("Network Error")) {
      ...
      if (bodyT["message"] == "Successful") {
        ...
        setState(() {
         // _bundles = Bundles.fromJson(value);
          product = BundleDetails.fromJson(value);
          loading = false;
          dataLoaded = true;
        });
      } else {
  ...
  void createBundleWishList(int id) {
    print("We are In now...");
    ServiceClass serviceClass = new ServiceClass();
    serviceClass.createBundleWishList(2, id).then((value) => wishlistOutput(value));
  }

  void wishlistOutput(String body) {
    print("We are In second  now...");
    var bodyT = jsonDecode(body);
    print(bodyT);
    _showMessage(bodyT["message"]);
