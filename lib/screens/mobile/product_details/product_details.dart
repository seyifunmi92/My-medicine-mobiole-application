...
class ProductID extends StatefulWidget {
  ...
  @override
  _ProductIDState createState() => _ProductIDState();
}

class _ProductIDState extends State<ProductID> with TickerProviderStateMixin {
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          color:product != null ? product!.totalQuantityInStock != 0 ? kPrimaryColor : kColorSmoke2 : null,
                          borderRadius: BorderRadius.circular(5)
                        ),
                        padding:
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(product != null ? product!.name! + " added to cart" : "" ,
                                style: TextStyle(
                                  fontFamily: "Poppins",
                                  fontSize: 11,
                                  fontWeight: FontWeight.w600,
