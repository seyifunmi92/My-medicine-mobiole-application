...
import 'package:mymedicinemobile/screens/mobile/orders/submiter.dart';
// ignore: unused_import
...
class RefundMethod extends StatefulWidget {
  const RefundMethod({Key? key}) : super(key: key);
  @override
  _RefundMethod createState() => _RefundMethod();
}

class _RefundMethod extends State<RefundMethod> {
              ...
              child: Column(
                children: [
                  navBarCustomCartBeforePerson(
                      "Request Return", context, Cart(), true),
                  const SizedBox(
                    height: 10,
                  ),
                  Container(
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const Text(
                                "Your refund will be sent to your wallet once we are done reviewing your Return Request.",
                                style: TextStyle(
                                    fontFamily: "Poppins",
                                    fontSize: 15,
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            padding:
                const EdgeInsets.only(top: 20, left: 20, right: 30, bottom: 20),
            decoration: BoxDecoration(
                boxShadow: [
                  BoxShadow(
                    color: kColorSmoke.withOpacity(.2),
