...
class UploadPrescription extends StatefulWidget {
  ...
  UploadPrescription(this.salesOrderId,this.uniqueSalesOrderId,this.items,this.total);
  _UploadPrescription createState() => new _UploadPrescription();
}
...
class _UploadPrescription extends State<UploadPrescription> {
  ...
  Widget customMedias(File file) => Container(
        child: Stack(
          children: [
            ClipRRect(borderRadius: BorderRadius.circular(10),child: Image.file(file,width: 100,height: 100,)),
            Positioned(
                bottom: 10,
                left: 20,
                right: 20,
            ...
            children: [
              Column(
                children: [
                  ...
                  Container(height: height *.84,child:
                    ListView(children: [
                      SizedBox(
                        height: 10,
                      ),
                      ...
                      showList
                        ...
                        child: GridView(
                            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                ...
                                mainAxisSpacing: 4,
                                crossAxisCount: 5),
                            children: imgList.map((e) => customMedias(e)).toList()
                        ),
                      )
                          : Text(""),
  ...
  showAlertDialog(BuildContext context) {
    AlertDialog alert = AlertDialog(
      title: Text("Loading ..."),
      content: Container(padding: EdgeInsets.all(5),width: 150,height: 150,child: Center(child: CircularProgressIndicator())),
      actions: [
  ...
  void _uploadInfo(List<File> _files) async {
    ...
    try {
      FormData formData = new FormData.fromMap({
        "salesOrderId": widget.salesOrderId.toString(),
        "prescriptionId": "",
        "files": [
